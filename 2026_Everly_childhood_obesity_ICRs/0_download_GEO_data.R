...
# Load processed CpG beta-value dataframes and raw BMI dat
...
raw_bmi_data <- read_csv(list.files(tmp, pattern = "\\Supplementary_data_obesity.csv(\\.gz)?$", recursive = TRUE, full.names = TRUE)[1])
